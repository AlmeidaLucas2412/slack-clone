          ...
          <div className="p-2">
            <div className="relative size-16 flex items-center justify-center group/image">
              ...
              <Image
                ...
                alt="Uploaded"
                fill
                className="rounded-xl overflow-hidden border object-cover cursor-pointer"
              />
            </div>
          </div>
        )}
          ...
          {variant === "update" && (
            <div className="ml-auto flex items-center gap-x-2">
              ...
              <Button
                ...
                size="sm"
                className="bg-emerald-700 hover:bg-emerald-700/80 text-white"
              >
                Save
              </Button>
            </div>
            ...
            <Button
              ...
              className={cn(
                ...
                isEmpty
                  ...
                  : "bg-emerald-700 hover:bg-emerald-700/80 text-white"
              )}
            >
